...
//#region src/assets/revo-portrait.jpg
var revo_portrait_default = "/assets/revo-portrait-C_fIAo5m.jpg";
//#endregion
//#region src/components/CursorReticle.tsx
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				!active && /* @__PURE__ */ jsx("div", { className: "h-1 w-1 rounded-full bg-white" })
			]
		})
	});
}
//#endregion
//#region src/components/RevealOnScroll.tsx
	...
	return /* @__PURE__ */ jsxs("header", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: ["REVO", /* @__PURE__ */ jsx("span", {
					style: { color: "var(--neon)" },
					children: "."
				})]
			}),
			/* @__PURE__ */ jsxs("nav", {
				className: "hidden md:flex items-center gap-8 font-mono text-[11px] tracking-[0.2em] uppercase text-white/60",
				children: [
					/* @__PURE__ */ jsx("a", {
						href: "#shorts",
...
function ShortCard({ item, idx }) {
	...
	return /* @__PURE__ */ jsx(RevealOnScroll, {
		delay: idx * 120,
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				hover && /* @__PURE__ */ jsx(FauxClip, { seed: idx + 1 }),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", { children: ["RET ", /* @__PURE__ */ jsx("span", {
								className: "text-white",
								children: item.retention
							})] }),
							/* @__PURE__ */ jsxs("div", { children: ["VIEWS ", /* @__PURE__ */ jsx("span", {
								className: "text-white",
								children: item.views
							})] }),
							/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx(RevealOnScroll, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				hover && /* @__PURE__ */ jsx(FauxClip, { seed: idx + 99 }),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("span", { children: ["RUNTIME · ", /* @__PURE__ */ jsx("span", {
								className: "text-white",
								children: item.duration
							})] }),
							/* @__PURE__ */ jsxs("span", { children: ["AVD · ", /* @__PURE__ */ jsx("span", {
								className: "text-white",
								children: item.avd
							})] }),
							/* @__PURE__ */ jsxs("span", { children: ["CTR · ", /* @__PURE__ */ jsx("span", {
								style: { color: "var(--neon)" },
								children: item.ctr
							})] })
						]
		...
		/* @__PURE__ */ jsxs("main", {
			...
			children: [
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-6 md:inset-10 border border-white/10" }),
						/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsxs(RevealOnScroll, { children: [/* @__PURE__ */ jsx(SectionLabel, {
						idx: "01",
						...
						children: SHORT_CATS.map((item, i) => /* @__PURE__ */ jsx(ShortCard, {
							item,
							idx: i
						}, item.id))
					})]
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx("div", {
							...
							children: [...TESTIMONIALS, ...TESTIMONIALS].map((t, i) => /* @__PURE__ */ jsxs("article", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(RevealOnScroll, { children: [
