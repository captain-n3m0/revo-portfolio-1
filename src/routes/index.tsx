  ...
  return (
    <>
      ...
      <main className="relative">
        ...
        {/* ============ SHORTS ARCHIVE ============ */}
        <section id="shorts" className="relative px-6 md:px-16 py-32">
          <RevealOnScroll>
        ...
        {/* ============ LONG-FORM ============ */}
        <section id="longform" className="relative px-6 md:px-16 py-32 border-t border-white/5">
          <RevealOnScroll>
        ...
        {/* ============ TESTIMONIALS ============ */}
        <section id="proof" className="relative py-32 border-t border-white/5 overflow-hidden">
        ...
        {/* ============ BOOK A CALL ============ */}
        <section id="book" className="relative px-6 md:px-16 py-32 border-t border-white/5">
